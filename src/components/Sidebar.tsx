...
import { MessageSquare, Settings, LogOut, Terminal, FolderOpen, HardDriveDownload, Search } from "lucide-react";
      ...
      >
        ...
        <Link
          ...
          style={{
            ...
            height: "36px",
            borderRadius: "8px",
            color: isRouteActive(["/qobuz"]) ? "var(--accent-blue)" : "var(--text-secondary)",
            backgroundColor: isRouteActive(["/qobuz"]) ? "var(--accent-blue-transparent)" : "transparent",
            transition: "all 0.2s ease",
          }}
          title="Qobuz 商店搜索"
        >
